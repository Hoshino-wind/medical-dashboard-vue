export const themes = [
  ...
  },
  {
    ...
    variables: {
      "--bg": "#020916",
      "--bg-soft": "#06152d",
      "--surface": "rgba(3, 13, 31, 0.82)",
      "--surface-strong": "rgba(5, 24, 56, 0.92)",
      "--surface-muted": "rgba(8, 34, 75, 0.76)",
      "--border": "rgba(0, 168, 255, 0.34)",
      "--border-strong": "rgba(0, 196, 255, 0.74)",
      "--text": "#eef8ff",
      "--muted": "#8fb7d8",
      "--accent": "#00a8ff",
      "--accent-2": "#20f1d4",
      ...
      "--warn": "#ffc857",
      "--danger": "#ff5e78",
      "--chart-grid": "rgba(132, 187, 230, 0.14)",
      "--panel-shadow": "0 16px 42px rgba(0, 168, 255, 0.18), inset 0 0 26px rgba(16, 127, 255, 0.06)",
    },
  },
  {
    id: "aurora-purple",
